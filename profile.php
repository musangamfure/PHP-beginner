	...
	<?php require "header.php";?>
		...
		<div style="margin: auto;max-width: 600px">
			...
			<?php elseif(!empty($_GET['action']) && $_GET['action'] == 'edit'):?>
				...
				<form method="post" enctype="multipart/form-data" style="margin: auto;padding:10px;">
					<img src="<?php echo $_SESSION['info']['image']?>" style="width: 100px;height: 100px;object-fit: cover;margin: auto;display: block; border-radius: 50%;">
					<div style="display: flex; align-items: center; width:100%">
                        image: <input type="file" name="image">
                    </div>
					<input value="<?php echo $_SESSION['info']['username']?>" type="text" name="username" placeholder="Username" required>
					<input value="<?php echo $_SESSION['info']['email']?>" type="email" name="email" placeholder="Email" required>
			...
			<?php else:?>
				...
				<div style="margin: auto;max-width: 600px;text-align: center;">
					<div>
						<td><img src="<?php echo $_SESSION['info']['image']?>" style="width: 150px;height: 150px;object-fit: cover; border-radius: 50%"></td>
					</div>
					<div>
